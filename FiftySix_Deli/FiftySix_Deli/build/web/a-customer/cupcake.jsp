    ...
    <div class="menu">
        <p>Menu</p>
                ...
                <ul>
                    ...
                    <li class="active"><a href="/FiftySix_Deli/menuController?action=viewCupcake">Cup Cake</a></li>
                    <li><a href="/FiftySix_Deli/menuController?action=viewDessert">Dessert</a></li>
