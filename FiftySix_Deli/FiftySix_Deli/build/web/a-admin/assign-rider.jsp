...
<body>  
    ...
    <div class="main-content">
        ...
        <main>
            <h4 style="margin-top: 100px";>List of Available Rider</h4>
          ...
          <thead>
           ...
           <tbody>
               ...
               <c:forEach items= "${riders}" var= "riders" > 
                <c:if test="${riders.status.equals('Active')}">
                <tr>
                 ...
                 <td>
                    <center>
                        <a  href="/FiftySix_Deli/assignRiderController?action=updateOrder&rider_id=<c:out value="${riders.riderID}"/>&order_id=<%= request.getParameter("order_id") %>"><button>Assign Rider</button></a>
                    </center>
                 </td>
                </c:if>
          </c:forEach>
