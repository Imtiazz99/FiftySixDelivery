...
<script type="text/javascript"> 
    ...
    function validate(){
        ...
        else if(!document.getElementById('admin_email').value.match(emailletters)){
   ...
   <%
                              if(request.getAttribute("errMessage") == null) {
                                  out.println("");
                                    ...
                                    out.println("<script>swal('Please Try Again','Incorrect email and password','warning')</script>");
                              }
