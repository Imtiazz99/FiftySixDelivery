...
<body>  
    ...
    <div class="main-content">
        ...
        <main><br><br><br>
            <h4>List of Pending Orders</h4>
            <a href="/FiftySix_Deli/assignRiderController?action=ViewAssignedOrder"/><button class="btn btn-primary">List of assigned order</button></a>
          ...
          <thead>
           ...
           <tbody> 
                <c:forEach items= "${orders}" var= "orders" >  
                 ...
                 <td>
                <center>
                        <a href="/FiftySix_Deli/assignRiderController?action=viewRiders&order_id=<c:out value="${orders.orderid}"/>"/><button>View Rider</button></a>
                    </center>
                 </td>
                 </c:if>
                 </c:forEach>
