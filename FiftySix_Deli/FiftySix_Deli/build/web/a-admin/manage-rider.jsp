    ...
    <div class="main-content">
        ...
        <main>
          ...
          <thead>
           ...
           <c:forEach items="${riders}" var="riders">            
                <tr>
                 <td><c:out value="${riders.riderName}"/></td>
                 <td><c:out value="${riders.identificationNo}"/></td>
                 <td><c:out value="${riders.riderPhone}"/></td>
                 <td><c:out value="${riders.plateNo}"/></td>
                 <td><c:out value="${riders.regDate}"/></td>
                 <td><c:out value="${riders.status}"/></td>
                 <td>
                    <center>
                        <a href="riderController?action=deleteRider&rider_ID=<c:out value="${riders.riderID}"/>"><i class="fas fa-times" onclick="return confirm('Are you sure you want to delete this rider?')" aria-hidden="true" style="color:red"></i></a>
                    </center>
                 </td>
                </tr>
           </c:forEach>
 ...
 <%
                              if(request.getAttribute("successr") == null) {
                                  out.println("");
                                     ...
                                     out.println("<script>swal('Rider Successfully Deleted!','','success')</script>");
                              }
