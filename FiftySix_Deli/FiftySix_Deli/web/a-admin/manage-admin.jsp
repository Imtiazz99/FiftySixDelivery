...
<body>  
    ...
    <div class="main-content">
        ...
        <main>
            ...
            <div class="heading">
                <h4>List of Admin</h4>
                <a href="add-admin.jsp"><button class="button btn1">Register Admin</button></a>
            </div>
          ...
          <thead>
           ...
           <c:forEach items="${admins}" var="admins">            
                <tr>
                 ...
                 <td><c:out value="${admins.phoneNo}"/></td>
                 <td>
                    <center>
                        <a href="adminController?action=deleteAdmin&admin_ID=<c:out value="${admins.adminID}"/>"><i class="fas fa-times" onclick="return confirm('Are you sure you want to delete this admin?')" aria-hidden="true" style="color:red"></i></a>
                    </center>
                 </td>
                </tr>
           </c:forEach>
 ...
 <%
                              if(request.getAttribute("successr") == null) {
                                  out.println("");
                                     ...
                                     out.println("<script>swal('Admin Successfully Deleted!','','success')</script>");
                              }
