<%-- 
    Document   : manage menu
    Created on : 18 Jan 2021, 7:26:13 am
    Author     : Ayuni
--%>
                ...
                <tbody>
                    <c:forEach items="${menu}" var="menu">
                        <tr>
                            ...
                            <td><c:out value="${menu.menuQuan}" /></td>
                            <td>
                                <a href="/FiftySix_Deli/menuController?action=viewMenu&menuID=<c:out value="${menu.menuID}"/>"><i class="fas fa-eye" ></i></a>&nbsp;
                                <a href="/FiftySix_Deli/menuController?action=deleteMenu&menuID=<c:out value="${menu.menuID}"/>"><i class="fas fa-times" onclick="return confirm('Are you sure you want to delete this menu?')" aria-hidden="true" style="color:red"></i></a> &nbsp;
                                <a href="/FiftySix_Deli/menuController?action=updateMenu&menuID=<c:out value="${menu.menuID}"/>"><i class="fas fa-pen" ></i></a>
