 <%-- 
    Document   : viewOrder
    Created on : 13 Feb 2021, 3:28:10 pm
    Author     : TK
--%>
        ...
        <table id="dt-basic-checkbox" class="table table-striped table-bordered" cellspacing="0" width="100%">
            ...
            <c:forEach items= "${orders}" var= "orders" >
                ...
                <td><center>
                     ...
                     <a href="/FiftySix_Deli/orderCustController?action=orderCustomerDetails&order_id=<c:out value="${orders.orderid}"/>"/>View Details</a></button></center>
                 </td>
                </tr>
                </c:if>
